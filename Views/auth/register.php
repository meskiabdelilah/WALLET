...
<body class="bg-[#0B0F19] text-slate-300 h-screen flex items-center justify-center overflow-hidden selection:bg-violet-500 selection:text-white relative">
    ...
    <div class="w-full max-w-md px-6 py-4 h-full overflow-y-auto flex flex-col justify-center">

        <div class="flex flex-col items-center mb-6">
            <div class="h-14 w-14 bg-violet-600 rounded-2xl flex items-center justify-center text-white text-xl shadow-[0_0_15px_rgba(139,92,246,0.5)] mb-3">
                <i class="fa-solid fa-user-plus"></i>
            </div>
            <h1 class="text-2xl font-bold text-white tracking-tight">Nouveau Wallet</h1>
            <p class="text-slate-500 text-sm mt-1">Créez votre compte en quelques secondes</p>
        </div>

        <div class="bg-[#1F2937] border border-slate-700 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
            ...
            <form action="/wallet/src/service/register_service.php" method="POST" class="space-y-4">
                <input type="hidden" name="csrf_token" value="<?= Security::generateCSRFToken() ?>">

                <div>
                    <label class="text-xs text-slate-500 font-bold ml-1 uppercase block mb-1">Nom</label>
                    <div class="relative">
                ...
                <div>
                    <label class="text-xs text-slate-500 font-bold ml-1 uppercase block mb-1">Email</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500">
                ...
                <div>
                    <label class="text-xs text-slate-500 font-bold ml-1 uppercase block mb-1">Confirmer mot de passe</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500">
                ...
                <div class="flex items-center text-xs mt-2">
                    <label class="flex items-center gap-2 text-slate-400 cursor-pointer hover:text-white transition select-none">
        ...
        <div class="text-center mt-6">
            <p class="text-slate-500 text-sm">
                Déjà membre ?
                <a href="login.php" class="text-violet-400 font-bold hover:text-violet-300 transition">Se connecter</a>
            </p>
        </div>
